...
// Adjust these constants as per your actual API setup
...
(async () => {
    ...
    const messages = [
        {
            ...
            Use google search by set a sub-page like 'https://google.ru/search?q=search' if applicable. Prefer to use Google for simple queries. If the user provides a direct URL, go to that one. Do not make up links`,
        }
    ];

    console.log("Agent: How can I assist you today? ")
    ...
    while( true ) {
        ...
        const response = await openai.chat.completions.create({
            model: "llava", // Adjust model name as per your setup
            messages: messages,
        });
